...
A personal operating system — principles, protocols, and frameworks for living well.
...
| File | What's in it |
|------|-------------|
| [Reading System](learning/reading-system.md) | How to read for retention and behavior change |
| [Skill Building](learning/skill-building.md) | How to learn deliberately, meta-skills, when to stop |

## Routines

| File | What's in it |
|------|-------------|
| [Daily](routines/daily.md) | Morning and evening anchors, non-negotiables |
| [Weekly Review](routines/weekly-review.md) | Full weekly reset template |
| [Annual Review](routines/annual-review.md) | Year-in-review and year-ahead planning |
...
- [Quotes](quotes.md) — compressed philosophy from people who earned it
